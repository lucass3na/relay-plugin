---
name: code-writer
description: "Delegate boilerplate code generation to a cheap headless Claude worker. Use for tests, config, docstrings, type stubs, or any generation where >80% is predictable from reference files."
---
